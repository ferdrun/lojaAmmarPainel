  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php echo ($viewData['menuActive']=='categories')?'active':''; ?>"><a href="<?php echo BASE_URL; ?>categories"><i class="fa fa-link"></i> <span>Coleções</span></a></li>
        <?php endif; ?>

        <?php if( $viewData['user']->hasPermission('brands_view') ): ?>
        <li class="<?php echo ($viewData['menuActive']=='brands')?'active':''; ?>"><a href="<?php echo BASE_URL; ?>brands"><i class="fa fa-link"></i> <span>Categorias</span></a></li>
        <?php endif; ?>
